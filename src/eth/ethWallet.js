...
//
EthWallet.prototype.canSendInstant = function() {
...
//
EthWallet.prototype.instantBalance = function() {
...
//
EthWallet.prototype.addresses = function(params, callback) {
  params = params || {};
  common.validateParams(params, [], [], callback);
...
//
EthWallet.prototype.unspents = function(params, callback) {
  params = params || {};
  common.validateParams(params, [], [], callback);
...
//   instant: only find instant transactions (must specify a target)
//
EthWallet.prototype.unspentsPaged = function(params, callback) {
  params = params || {};
  common.validateParams(params, [], [], callback);
 ...
 * @returns {*}
 */
EthWallet.prototype.fanOutUnspents = function(params, callback) {
 ...
 */
EthWallet.prototype.regroupUnspents = function(params, callback) {
  params = params || {};
  var target = params.target;
 ...
 * @returns {*}
 */
EthWallet.prototype.consolidateUnspents = function(params, callback) {
  params = params || {};
  common.validateParams(params, [], ['walletPassphrase', 'xprv'], callback);
  var validate = params.validate === undefined ? true : params.validate;
